                ...
                <div class="mt-4 px-4">
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.home.inputs.name')
                        </h5>
                        <span>{{ $home->name ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.home.inputs.text')
                        </h5>
                        <span>{{ $home->text ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.home.inputs.image')
                        </h5>
                        <video controls autoplay src="{{ $home->image }}">{{ $home->image ?? '-' }}</video>
                    </div>
                </div>
