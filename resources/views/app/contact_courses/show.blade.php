<x-app-layout>
    @section('title', 'Show Contact Course')
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.contact_course.show_title')
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                <x-slot name="title">
                    <a href="{{ route('contact-courses.index') }}" class="mr-4"
                ...
                <div class="mt-10">
                    <a
                        href="{{ route('contact-courses.index') }}"
                        class="button"
                    >
