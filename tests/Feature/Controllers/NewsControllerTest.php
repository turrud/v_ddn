...
class NewsControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_all_news(): void
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_news(): void
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_news(): void
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_news(): void
    {
        $news = News::factory()->create();
